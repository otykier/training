// Credit: Michael Kovalsky
// Source: https://github.com/m-kovalsky/ProcessingManager/blob/main/ProcessBatches.cs
...
if(string.IsNullOrEmpty(batchName)) {
    batchName = Interaction.InputBox("Enter batch name", "Batch name");
    if(string.IsNullOrEmpty(batchName)) return;
}
bool runTMSL = true;
